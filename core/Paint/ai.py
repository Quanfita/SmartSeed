...
with tf.device(device_A):
    ...
    baby = load_model('./model/baby.net')
    ...
    neck = load_model('./model/neck.net')
...
with tf.device(device_B):
    ...
    tail = load_model('./model/tail.net')
    pads = 7
...
tail.load_weights('./model/tail.net')
baby.load_weights('./model/baby.net')
head.load_weights('./model/head.net')
neck.load_weights('./model/neck.net')
girder.load_weights('./model/girder.net')
reader.load_weights('./model/reader.net')
