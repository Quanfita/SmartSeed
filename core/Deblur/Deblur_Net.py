...
from appendix import psnr,ssim
...
class Deblur_Net():
    ...
    def build_graph(self):
        ...
        self.PSNR = tf.reduce_mean(psnr(((self.gene_img + 1.0) / 2.0), ((label + 1.0) / 2.0), max_val = 1.0))
        self.ssim = tf.reduce_mean(ssim(((self.gene_img + 1.0) / 2.0), ((label + 1.0) / 2.0), max_val = 1.0))
